...
from app.utils.cache import cached_response, invalidate_cache
...
@cached_response(ttl=120, key_prefix="rc")
async def list_system_prompts(
    ...
    """List non-deleted system prompts for the current user with pagination."""
    user_id = get_user_id(payload)

    base_query = select(SystemPrompt).where(
...
async def create_system_prompt(
    ...
    await invalidate_cache("rc:list_system_prompts:*")
