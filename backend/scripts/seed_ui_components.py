...
COMPONENTS = [
    ...
    },
    {
        ...
        "html_template": '<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4"><div class="aspect-square overflow-hidden rounded-lg"><img src="{{image.src}}" alt="{{image.alt}}" class="h-full w-full object-cover hover:scale-105 transition-transform" /></div></div>',
